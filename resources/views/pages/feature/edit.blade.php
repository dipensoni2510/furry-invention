                            ...
                            <form method="POST" action="/features/{{ $feature->id }}">
                              ...
                              @method('PUT')
                                <div class="form-label-group mb-0 mt-1">
                                    ...
                                    <input id="name" type="text" class="form-control @error('name') is-invalid @enderror" name="name" placeholder="Company Name" value="{{ $feature->name }}" autocomplete="name">
...
<div class="flexbox-container">
  <div class="col-12">
    <a href="/features" class="btn btn-outline-warning mr-1">Cancel</a>

                          ...
                          <div class="card-body pt-0 pb-0 pr-0 pl-0">
                            <form method="POST" action="{{route('companies.store')}}">
                              ...
                              <div class="form-label-group mt-1 mb-0">
                                ...
                                <input id="name" type="text" class="form-control @error('name') is-invalid @enderror" name="name" placeholder="Feature Name" value="{{ old('name') }}" autocomplete="name" autofocus>
...
<div class="flexbox-container">
  <div class="col-12">
    <a href="/companies" class="mr-1 btn btn-outline-warning">Cancel</a>

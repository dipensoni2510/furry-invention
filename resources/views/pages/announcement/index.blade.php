...
@section('title', 'Announcement List Page')
      ...
      <div class="col-12">
        <div class="card">
           <div class="card-header">
            <a href="{{ route('announcements.create')}}" class="btn btn-primary">Add Announcements</a>
          </div>
          <div class="card-content">
            <div class="card-body card-dashboard">
              <div class="table-responsive">
                <table id="announcementTable" class="table zero-configuration data-table">
                  <thead>
                  <tr>
                    <th>ID</th>
                    <th>Title</th>

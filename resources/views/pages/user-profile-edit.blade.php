          ...
          <div class="card rounded-0 mb-0 p-2">
            ...
            <div class="card-content">
              <div class="card-body pt-0 pb-0 pr-0 pl-0">
                <form method="POST" action="/edit-self">
                  @csrf
                  @method('PUT')
                  ...
                  <div class="form-label-group pb-1">
                    <input id="email" type="text" class="form-control @error('email') is-invalid @enderror" name="email" placeholder="Email" value="{{ $user->email }}" required autocomplete="email" @error('last_name') autofocus @enderror>
                  ...
                  <div class="form-label-group mb-0">
                    <input id="mobile" type="text" class="form-control @error('mobile') is-invalid @enderror" name="mobile" placeholder="Mobile" value="{{ $user->mobile }}" required autocomplete="mobile" @error('mobile') autofocus @enderror>

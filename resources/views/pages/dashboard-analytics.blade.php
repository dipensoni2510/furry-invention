    ...
    <div class="card-content">
      <div class="card-body">
        <div class="avatar bg-rgba-dark p-50 m-0 mb-1">
          <div class="avatar-content">
            <i class="feather icon-user text-dark font-medium-5"></i>
          </div>
        </div>
        <h2 class="text-bold-700">{{$users}}</h2>
        <p class="mb-1 line-ellipsis">Total Clients</p>
      </div>
    </div>
  </div>
</div>
  ...
  <div class="card text-center">
    <div class="card-content">
      <div class="card-body">
        ...
        <h2 class="text-bold-700">{{ $companies }}</h2>
        <p class="mb-1 line-ellipsis">Total Vehicle Companies</p>
      </div>
    </div>
  </div>
</div>
    ...
    <div class="card-content">
      <div class="card-body">
        <div class="avatar bg-rgba-warning p-50 m-0 mb-1">
          <div class="avatar-content">
            <i class="fa fa-car text-warning font-medium-5"></i>
          </div>
        </div>
        <h2 class="text-bold-700">{{ $vehicles }}</h2>
        <p class="mb-1 line-ellipsis">Total Vehicles</p>
      </div>
    </div>
  </div>
</div>
    ...
    <div class="card-content">
      <div class="card-body">
        <div class="avatar bg-rgba-info p-50 m-0 mb-1">
          <div class="avatar-content">
            <i class="fa fa-cart-arrow-down text-info font-medium-5"></i>
          </div>
        </div>
        <h2 class="text-bold-700">{{ $orders }}</h2>
        <p class="mb-1 line-ellipsis">Total Orders</p>
      </div>
    </div>
  </div>
</div>
    ...
    <div class="card-content">
      <div class="card-body">
        <div class="avatar bg-rgba-secondary p-50 m-0 mb-1">
          <div class="avatar-content">
            <i class="fa fa-list-ul text-secondary font-medium-5"></i>
          </div>
        </div>
        <h2 class="text-bold-700">{{ $featurs }}</h2>
        <p class="mb-1 line-ellipsis">Total Features</p>
      </div>
    </div>
  </div>
</div>
    ...
    <div class="card-content">
      <div class="card-body">
        <div class="avatar bg-rgba-success p-50 m-0 mb-1">
          <div class="avatar-content">
            <i class="fa fa-search-plus text-success font-medium-5"></i>
          </div>
        </div>
        <h2 class="text-bold-700">{{ $totalReturnedVehicles }}</h2>
        <p class="mb-1 line-ellipsis">Total Returned Vehicles</p>
      </div>
    </div>
  </div>
</div>
    ...
    <div class="card-content">
      <div class="card-body">
        <div class="avatar bg-rgba-danger p-50 m-0 mb-1">
          <div class="avatar-content">
            <i class="fa fa-search-minus text-danger font-medium-5"></i>
          </div>
        </div>
        <h2 class="text-bold-700">{{ $totalNotReturnedVehicles }}</h2>
        <p class="mb-1 line-ellipsis">Total Not Returned Vehicles</p>
      </div>
    </div>
  </div>
</div>
  ...
  <div class="card text-center">
    <div class="card-content">
      <div class="card-body">
        ...
        <h2 class="text-bold-700">{{ $companies }}</h2>
        <p class="mb-1 line-ellipsis">Total Available Vehicle Companies</p>
      </div>
    </div>
  </div>
</div>
  ...
  <div class="card text-center">
    <div class="card-content">
      <div class="card-body">
        ...
        <h2 class="text-bold-700">{{$vehicles}}</h2>
        <p class="mb-1 line-ellipsis">Total Available Vehicles</p>
      </div>
    </div>
  </div>
</div>
  ...
  <div class="card text-center">
    <div class="card-content">
      <div class="card-body">
        <div class="avatar bg-rgba-primary p-50 m-0 mb-1">
          <div class="avatar-content">
            <i class="fa fa-cart-arrow-down text-primary font-medium-5"></i>
          </div>
        </div>
        <h2 class="text-bold-700">{{$ordersByUser}}</h2>
        <p class="mb-1 line-ellipsis">Total Ordered Vehicles</p>
      </div>
    </div>
  </div>
</div>
  ...
  <div class="card text-center">
    <div class="card-content">
      <div class="card-body">
        ...
        <h2 class="text-bold-700">{{$returnVehicle}}</h2>
        <p class="mb-1 line-ellipsis">Total Vehicles Returned</p>
      </div>
    </div>
  </div>
</div>
  ...
  <div class="card text-center">
    <div class="card-content">
      <div class="card-body">
        ...
        <h2 class="text-bold-700">{{$notReturnVehicles}}</h2>
        <p class="mb-1 line-ellipsis">Total Vehicles Not Returned</p>
      </div>
    </div>
  </div>
</div>
